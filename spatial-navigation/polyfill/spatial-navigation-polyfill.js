...
(function () {
   ...
   * @returns {boolean}
   */
  function isInsideJS(containerRect, childRect) {
   ...
   * @returns {boolean}
   */
  function isOutsideJS(rect1, rect2, dir) {
    switch (dir) {
      case 'left':
        return isRightSideJS(rect2, rect1);
      case 'right':
        return isRightSideJS(rect1, rect2);
      case 'up':
        return isBelowJS(rect2, rect1);
      case 'down':
        return isBelowJS(rect1, rect2);
      default:
        return false;
    }
  }
  ...
  function isRightSideJS(rect1, rect2) {
  ...
  /* rect1 is below of rect2 */
  function isBelowJS(rect1, rect2) {
  ...
  /* Implementación JS de isAligned */
  function isAlignedJS(rect1, rect2, dir) {
    switch (dir) {
      case 'left':
      case 'right':
   ...
   */
  function getEntryAndExitPointsJS(dir = 'down', searchOrigin, candidateRect) {
    /**
